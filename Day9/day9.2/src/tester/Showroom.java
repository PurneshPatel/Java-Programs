...
public class Showroom {
	...
	public static void main(String[] args) {
		try (Scanner sc = new Scanner(System.in)) {
			...
			Vehicle[] vehicles = new Vehicle[100];// 1 array object : holder for Vehicle type of refs
			boolean exit = false;
			int counter = 0;
			while (!exit) {
				...
				try {
					...
					case 1:
						if (counter < vehicles.length) {
							System.out.println("Enter vehicle details : regno clr price date(day-mon-yr) type");
